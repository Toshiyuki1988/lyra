...
(function () {
  ...
  const PRESETS = [
    ...
    },
    {
      ...
      guide: 'ostinato を2〜4つ。active で鳴る区間を分け、区間が変わると別のブロックへ突然切り替わるようにする(展開しない)。accent を音型の長さとずらして拍をずらす。chords を足すなら comping stabs とポリコード(「C|F#」)。line(role melody)は民謡風の狭い音域の短い句を少しだけ',
